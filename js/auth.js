...
export async function signInWithGoogle() {
  ...
  const credentials = await authModule.signInWithPopup(auth, provider);
  return { credentials, isNewUser: Boolean(authModule.getAdditionalUserInfo?.(credentials)?.isNewUser) };
}
